    ...
    children: [
      AdaptiveListTile(
        ...
        onTap: () async {
          ...
          // Launch UPI payment with your UPI ID
          await launchUrl(
            Uri.parse(
                'upi://pay?cu=INR&pa=patil.110@superyes&pn=ARE Music&am=&tn=Support ARE Music'),
      ...
      AdaptiveListTile(
        ...
        onTap: () async {
          Navigator.pop(context);
          await launchUrl(
            Uri.parse('https://buymeacoffee.com/rohitpatil'),
            mode: LaunchMode.externalApplication,
          );
        },
      ),
