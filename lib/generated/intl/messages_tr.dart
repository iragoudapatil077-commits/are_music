...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(count) => "${Intl.plural(count, zero: 'Şarkı Yok', one: '1 Şarkı', other: '${count} Şarkı')}";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'Add_To_Favourites': MessageLookupByLibrary.simpleMessage('Favorilere Ekle'),
    'Add_To_Library': MessageLookupByLibrary.simpleMessage('Kütüphaneye Ekle'),
    'Add_To_Playlist': MessageLookupByLibrary.simpleMessage('Çalma Listesine Ekle'),
    ...
    'Audio_And_Playback': MessageLookupByLibrary.simpleMessage('Ses ve Yeniden Oynatma'),
    'Backup': MessageLookupByLibrary.simpleMessage('Yedekle'),
    'Backup_And_Restore': MessageLookupByLibrary.simpleMessage('Yedekle ve Geri Yükle'),
    'Battery_Optimisation_message': MessageLookupByLibrary.simpleMessage('ARE Music\'in düzgün çalışması için pil optimizasyonunu devre dışı bırakmak için buraya tıklayın'),
    'Battery_Optimisation_title': MessageLookupByLibrary.simpleMessage('Pil Optimizasyonu Tespit Edildi'),
    'Bug_Report': MessageLookupByLibrary.simpleMessage('Hata Raporu'),
    'Buy_Me_A_Coffee': MessageLookupByLibrary.simpleMessage('Bana Bir Kahve Al'),
    'Cancel': MessageLookupByLibrary.simpleMessage('İptal'),
    'Check_For_Update': MessageLookupByLibrary.simpleMessage('Güncellemeleri Kontrol Et'),
    ...
    'Copied_To_Clipboard': MessageLookupByLibrary.simpleMessage('Panoya Kopyalandı'),
    'Country': MessageLookupByLibrary.simpleMessage('Ülke'),
    'Create': MessageLookupByLibrary.simpleMessage('Oluştur'),
    'Create_Playlist': MessageLookupByLibrary.simpleMessage('Çalma Listesi Oluştur'),
    'DOwnload_Quality': MessageLookupByLibrary.simpleMessage('İndirme Kalitesi'),
    'Delete_Item_Message': MessageLookupByLibrary.simpleMessage('Bu öğeyi silmek istediğinizden emin misiniz?'),
    'Delete_Playback_History': MessageLookupByLibrary.simpleMessage('Yeniden Oynatma Geçmişini Sil'),
    'Delete_Playback_History_Confirm_Message': MessageLookupByLibrary.simpleMessage('Yeniden Oynatma Geçmişini silmek istediğinizden emin misiniz.'),
    'Delete_Search_History': MessageLookupByLibrary.simpleMessage('Arama Geçmişini Sil'),
    'Delete_Search_History_Confirm_Message': MessageLookupByLibrary.simpleMessage('Arama Geçmişini silmek istediğinizden emin misiniz.'),
    'Developer': MessageLookupByLibrary.simpleMessage('Geliştirici'),
    'Donate': MessageLookupByLibrary.simpleMessage('Bağış Yap'),
    'Donate_Message': MessageLookupByLibrary.simpleMessage('ARE Music\'in geliştirilmesini destekleyin'),
    ...
    'Enable_Equalizer': MessageLookupByLibrary.simpleMessage('Ekolayzeri Etkinleştir'),
    'Enable_Playback_History': MessageLookupByLibrary.simpleMessage('Yeniden Oynatma Geçmişini Etkinleştir'),
    'Enable_Search_History': MessageLookupByLibrary.simpleMessage('Arama Geçmişini Etkinleştir'),
    'Enter_Visitor_Id': MessageLookupByLibrary.simpleMessage('Ziyaretçi Kimliği Girin'),
    ...
    'Import_Playlist': MessageLookupByLibrary.simpleMessage('Çalma Listesi İçe Aktar'),
    'Jhelum_Corp': MessageLookupByLibrary.simpleMessage('Jhelum Corp'),
    'Language': MessageLookupByLibrary.simpleMessage('Dil'),
    'Loudness_And_Equalizer': MessageLookupByLibrary.simpleMessage('Ses Yüksekliği ve Ekolayzer'),
    'Loudness_Enhancer': MessageLookupByLibrary.simpleMessage('Ses Yükseltici'),
    'Low': MessageLookupByLibrary.simpleMessage('Düşük'),
    'Made_In_Kashmir': MessageLookupByLibrary.simpleMessage('Keşmir de Yapıldı'),
    ...
    'Personalised_Content': MessageLookupByLibrary.simpleMessage('Kişiselleştirilmiş İçerik'),
    'Play_Next': MessageLookupByLibrary.simpleMessage('Sonraki Oynat'),
    'Playback_History_Deleted': MessageLookupByLibrary.simpleMessage('Yeniden Oynatma Geçmişi Silindi'),
    ...
    'Remove_All_History_Message': MessageLookupByLibrary.simpleMessage('Tüm geçmişi temizlemek istediğinizden emin misiniz?'),
    'Remove_From_Favourites': MessageLookupByLibrary.simpleMessage('Favorilerden Çıkar'),
    'Remove_From_Library': MessageLookupByLibrary.simpleMessage('Kütüphaneden Çıkar'),
    'Remove_From_YTMusic_Message': MessageLookupByLibrary.simpleMessage('YTMüzikten kaldırmak istediğinizden emin misiniz?'),
    'Remove_Message': MessageLookupByLibrary.simpleMessage('Kaldırmak istediğinizden emin misiniz?'),
    'Rename': MessageLookupByLibrary.simpleMessage('Yeniden Adlandır'),
    'Rename_Playlist': MessageLookupByLibrary.simpleMessage('Çalma Listesini Yeniden Adlandır'),
    'Reset_Visitor_Id': MessageLookupByLibrary.simpleMessage('Ziyaretçi Kimliğini Sıfırla'),
    'Restore': MessageLookupByLibrary.simpleMessage('Geri Yükle'),
    'Saved': MessageLookupByLibrary.simpleMessage('Kaydedilenler'),
    'Search_Gyawun': MessageLookupByLibrary.simpleMessage('ARE Music Ara'),
    'Search_History_Deleted': MessageLookupByLibrary.simpleMessage('Arama Geçmişi Silindi'),
    ...
    'Songs_Will_Start_Playing_Soon': MessageLookupByLibrary.simpleMessage('Şarkılar yakında çalmaya başlayacak.'),
    ...
    'Support_Me_On_Kofi': MessageLookupByLibrary.simpleMessage('Ko-fi üzerinden bana destek ol'),
