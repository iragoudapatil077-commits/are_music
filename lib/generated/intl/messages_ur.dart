...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(count) => "${Intl.plural(count, zero: 'کوئی گانے نہیں', one: '1 گانا', other: '${count} گانے')}";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'Add_To_Favourites': MessageLookupByLibrary.simpleMessage('پسندیدہ میں شامل کریں'),
    'Add_To_Library': MessageLookupByLibrary.simpleMessage('لائبریری میں شامل کریں'),
    'Add_To_Playlist': MessageLookupByLibrary.simpleMessage('پلے لسٹ میں شامل کریں'),
    ...
    'Audio_And_Playback': MessageLookupByLibrary.simpleMessage('آڈیو اور پلے بیک'),
    'Backup': MessageLookupByLibrary.simpleMessage('بیک اپ'),
    'Backup_And_Restore': MessageLookupByLibrary.simpleMessage('بیک اپ اور بحالی'),
    'Battery_Optimisation_message': MessageLookupByLibrary.simpleMessage('گیاون کو درست طریقے سے کام کرنے کے لئے بیٹری کی اصلاح کو غیر فعال کرنے کے لئے یہاں کلک کریں'),
    'Battery_Optimisation_title': MessageLookupByLibrary.simpleMessage('بیٹری کی اصلاح کا پتہ چلا'),
    'Bug_Report': MessageLookupByLibrary.simpleMessage('بگ رپورٹ'),
    'Buy_Me_A_Coffee': MessageLookupByLibrary.simpleMessage('مجھے ایک کافی خریدیں'),
    'Cancel': MessageLookupByLibrary.simpleMessage('منسوخ کریں'),
    'Check_For_Update': MessageLookupByLibrary.simpleMessage('اپ ڈیٹ کے لئے چیک کریں'),
    ...
    'Copied_To_Clipboard': MessageLookupByLibrary.simpleMessage('کلپ بورڈ پر کاپی کر دیا گیا'),
    ...
    'Delete_Item_Message': MessageLookupByLibrary.simpleMessage('کیا آپ واقعی اس آئٹم کو حذف کرنا چاہتے ہیں؟'),
    'Delete_Playback_History': MessageLookupByLibrary.simpleMessage('پلے بیک ہسٹری کو حذف کریں'),
    'Delete_Playback_History_Confirm_Message': MessageLookupByLibrary.simpleMessage('کیا آپ واقعی پلے بیک ہسٹری کو حذف کرنا چاہتے ہیں؟'),
    'Delete_Search_History': MessageLookupByLibrary.simpleMessage('تلاش کی ہسٹری کو حذف کریں'),
    'Delete_Search_History_Confirm_Message': MessageLookupByLibrary.simpleMessage('کیا آپ واقعی تلاش کی ہسٹری کو حذف کرنا چاہتے ہیں؟'),
    'Developer': MessageLookupByLibrary.simpleMessage('ڈویلپر'),
    'Donate': MessageLookupByLibrary.simpleMessage('عطیہ'),
    'Donate_Message': MessageLookupByLibrary.simpleMessage('ARE Music کی ترقی کی حمایت کریں'),
    ...
    'Enable_Equalizer': MessageLookupByLibrary.simpleMessage('ایکوالائزر کو فعال کریں'),
    'Enable_Playback_History': MessageLookupByLibrary.simpleMessage('پلے بیک ہسٹری کو فعال کریں'),
    'Enable_Search_History': MessageLookupByLibrary.simpleMessage('تلاش کی ہسٹری کو فعال کریں'),
    'Enter_Visitor_Id': MessageLookupByLibrary.simpleMessage('وزیٹر آئی ڈی درج کریں'),
    'Equalizer': MessageLookupByLibrary.simpleMessage('ایکولائزر'),
    'Favourites': MessageLookupByLibrary.simpleMessage('پسندیدہ'),
    'Feature_Request': MessageLookupByLibrary.simpleMessage('خصوصیت کی درخواست'),
    ...
    'Import_Playlist': MessageLookupByLibrary.simpleMessage('پلے لسٹ درآمد کریں'),
    'Jhelum_Corp': MessageLookupByLibrary.simpleMessage('جہلم کارپ'),
    'Language': MessageLookupByLibrary.simpleMessage('زبان'),
    'Loudness_And_Equalizer': MessageLookupByLibrary.simpleMessage('لاؤڈنس اور ایکوالائزر'),
    'Loudness_Enhancer': MessageLookupByLibrary.simpleMessage('لاؤڈنس انہینسر'),
    'Low': MessageLookupByLibrary.simpleMessage('کم'),
    'Made_In_Kashmir': MessageLookupByLibrary.simpleMessage('کشمیر میں بنایا گیا'),
    ...
    'Pay_With_UPI': MessageLookupByLibrary.simpleMessage('یو پی آئی کے ساتھ ادائیگی'),
    'Payment_Methods': MessageLookupByLibrary.simpleMessage('ادائیگی کے طریقے'),
    'Personalised_Content': MessageLookupByLibrary.simpleMessage('ذاتی بنایا گیا مواد'),
    'Play_Next': MessageLookupByLibrary.simpleMessage('اگلا چلائیں'),
    'Playback_History_Deleted': MessageLookupByLibrary.simpleMessage('پلے بیک ہسٹری حذف کر دی گئی'),
    ...
    'Remove_All_History_Message': MessageLookupByLibrary.simpleMessage('کیا آپ واقعی تمام تاریخ کو صاف کرنا چاہتے ہیں؟'),
    'Remove_From_Favourites': MessageLookupByLibrary.simpleMessage('پسندیدہ سے ہٹائیں'),
    'Remove_From_Library': MessageLookupByLibrary.simpleMessage('لائبریری سے ہٹائیں'),
    'Remove_From_YTMusic_Message': MessageLookupByLibrary.simpleMessage('کیا آپ واقعی اسے YTMusic سے ہٹانا چاہتے ہیں؟'),
    'Remove_Message': MessageLookupByLibrary.simpleMessage('کیا آپ واقعی اسے ہٹانا چاہتے ہیں؟'),
    'Rename': MessageLookupByLibrary.simpleMessage('نام تبدیل کریں'),
    'Rename_Playlist': MessageLookupByLibrary.simpleMessage('پلے لسٹ کا نام تبدیل کریں'),
    'Reset_Visitor_Id': MessageLookupByLibrary.simpleMessage('وزیٹر آئی ڈی دوبارہ ترتیب دیں'),
    'Restore': MessageLookupByLibrary.simpleMessage('بحال کریں'),
    'Saved': MessageLookupByLibrary.simpleMessage('محفوظ کردہ'),
    'Search_Gyawun': MessageLookupByLibrary.simpleMessage('گیاون تلاش کرنے کیلئے ARE Music'),
    'Search_History_Deleted': MessageLookupByLibrary.simpleMessage('تلاش کی ہسٹری حذف کر دی گئی'),
    ...
    'Songs_Will_Start_Playing_Soon': MessageLookupByLibrary.simpleMessage('گانے جلد ہی چلنا شروع ہوجائیں گے۔'),
    ...
    'Support_Me_On_Kofi': MessageLookupByLibrary.simpleMessage('کوفی پر مجھے سپورٹ کریں'),
