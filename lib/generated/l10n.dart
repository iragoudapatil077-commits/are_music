...
class S {
  ...
  /// `ARE Music`
  String get Gyawun {
    return Intl.message('ARE Music', name: 'Gyawun', desc: '', args: []);
  }
  ...
  /// `Click here disable battery optimisation for ARE Music to work properly`
  ...
  /// `Support the development of ARE Music`
